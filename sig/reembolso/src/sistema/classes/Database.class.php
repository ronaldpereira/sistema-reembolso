...
/**
 * @desc Remove um registro de uma tabela específica
 * @param unknown $table Tabela do registro
 * @param unknown $id Id do registro
 */
function query_remove($table, $id) {
	$q="DELETE FROM `".$this->pre.$table."` WHERE `id`=".$id;
	$this->query($q);
